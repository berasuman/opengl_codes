...
void ground(){
    ...
    // glEnd();
    glBegin(GL_POLYGON); 
        glColor3f(0.1,0.0,0.0);     //for the dead tree bark
        glVertex2d(785,390+ery);   //b 
        glVertex2d(785,150+ery);   //a  fixed point
        glVertex2d(875,150+ery);   //h   over
        glVertex2d(875,390+ery);   //g
        glVertex2d(920,450+ery);   //both axis scaled is to be done 
        glVertex2d(860,390+ery);
        glVertex2d(830,435+ery);
        glVertex2d(800,390+ery);   //d  over
        glVertex2d(710,450+ery);   //c
    glEnd();  // glPointSize(4);
    // glBegin(GL_POINT);
...
//Rocket Function
void rocket(int x)// one more parameter to be added 
{
    glBegin(GL_TRIANGLE_FAN); // Rocket Main Frame Head
    glColor3f(0.0,1.0,0.0);
    for (float t = -1.57; t <= PI/2; t += 0.001)
        glVertex2f(roc+980+(sin(t)*100),x+600+ery+(cos(t)*100));
    glEnd();
    glBegin(GL_QUADS);         //Main Rocket Body
        glColor3f(1.0,0.0,0.0);
        glVertex2i(roc+900,200+x+ery);
        glVertex2i(900+roc,450+x+ery);
        glVertex2i(1060+roc,450+x+ery);
        glVertex2i(1060+roc,200+x+ery);
    glEnd();
    glBegin(GL_QUADS);         //Main Rocket Body
        glColor3f(1.0,0.0,0.0);
        glVertex2i(roc+880,450+x+ery);
        glVertex2i(880+roc,600+x+ery);
        glVertex2i(1080+roc,600+x+ery);
        glVertex2i(1080+roc,450+x+ery);
    glEnd();
    int rboost=40; // radius of boosters
    glBegin(GL_TRIANGLE_FAN); // left Small booster Head
    glColor3f(0.0,1.0,0.0);
    for (float t = -1.57; t <= PI/2; t += 0.001)
        glVertex2f(roc+860+(sin(t)*rboost),x+350+ery+(cos(t)*rboost));
    glEnd();
    glBegin(GL_QUADS);  //left Small Booster
        glColor3f(1.0,0.2,1.0);
        glVertex2i(900+roc,220+x+ery);
        glVertex2i(900+roc,350+x+ery);
        glVertex2i(820+roc,350+x+ery);
        glVertex2i(820+roc,220+x+ery);
    glEnd();
    glBegin(GL_TRIANGLE_FAN); // right Small booster Head
    glColor3f(0.0,1.0,0.0);
    for (float t = -1.57; t <= PI/2; t += 0.001)
        glVertex2f(roc+1100+(sin(t)*rboost),x+350+ery+(cos(t)*rboost));
    glEnd();
    glBegin(GL_QUADS);  //right Small Booster
        glColor3f(1.0,0.0,1.0);
        glVertex2i(1060+roc,220+x+ery);
        glVertex2i(1060+roc,350+x+ery);
        glVertex2i(1140+roc,350+x+ery);
        glVertex2i(1140+roc,220+x+ery);
    glEnd();
    ...
    glBegin(GL_QUADS);  //bottom thrusters
        ...
        glVertex2i(910+roc,200+x+ery);
        glVertex2i(900+roc,170+x+ery);
        glVertex2i(1060+roc,170+x+ery);
        glVertex2i(1050+roc,200+x+ery);
    glEnd();
...
//         glColor3f(0.0,0.0,0.0);
//         glVertex2i(-2000+i,230+ery);        //torso
//         glVertex2i(-2000+j,330+ery);
//         glVertex2i(-2000+i,310+ery);        //Obvious left hand
//         glVertex2i(-2050+j+i,230+ery);
//         glVertex2i(-2000+i,310+ery);        //right hand
//         glVertex2i(-1950-j+i,230+ery);
//         glVertex2i(-2000+i,230+ery);        //Assumed left leg
//         glVertex2i(-2050+j+i,150+ery);
//         glVertex2i(-2000+i,230+ery);        //right leg
//         glVertex2i(-1950-j+i,150+ery);
//     glEnd();
// }
...
void display()
{
    ...
    //     glVertex2f(-2000+i+(sin(t)*40),(cos(t)*40)+ery+350);
    // glEnd();
    int triamount=20;
...
int main(int argc,char** argv)
{
    ...
    //glutFullScreen();     For Full Screen Uncomment it
    glutMainLoop();
}